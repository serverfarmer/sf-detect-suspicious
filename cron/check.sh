...
ps aux |egrep -i "(btc|carbon|coin|devfee|ether|miner|mining|torrent|xmr|yam|kinsing|kdevtmpfsi|libsystem)" |grep -v "grep " |grep -vFf /etc/local/.config/allowed.processes >>$file
